...
- **The node's own supervisor and CLI** — `flor`: the agent, plus `install`, `uninstall`, `enroll`, `id`, `version`.
...
<Callout title="Shipping a CA-capable binary is not shipping CA authority">
