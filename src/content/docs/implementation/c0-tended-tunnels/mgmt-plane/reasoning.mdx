...
Captured justifications behind the decisions in the C0 control and management planes, organised by topic. Decisions about principals, names, the root CA, credential life and the identity store are logged on [Identity](../identity#decision-log), and their reasoning lives there.
...
Applies uniformly whether the principal is a user or a service, which is what lets one role mechanism cover both ([ID-C0-06](../identity#decision-log)).
