...
flor vertex run   [--rete <scope>]          # the data-plane daemon spawned by the agent;
                  --vertex <name>           # same rete scope as the agent (auto-detected if
