...
| Filesystem directories holding collections of named instances | **plural** collection name | `certs/management-planes/primary.crt`, `artifacts/mgmt/sets/<v>/`, `~/.flor/retes/<scope>/` |
