...
| Filesystem directories holding collections of named instances | **plural** collection name | `identity/principals/alice.crt`, `artifacts/mgmt/sets/<v>/`, `<state-dir>/retes/<scope>/` |
