...
Establishes the vocabulary that [ADR-0005](/docs/implementation/adr/0005-use-spiffe-identities), [ADR-0006](/docs/implementation/adr/0006-impl-mtls-in-quic-endpoint), and [ADR-0007](/docs/implementation/adr/0007-decouple-naming-identity-routing) (and the C0/C1 implementation docs) were updated in place to use.
...
When node-clusters land, "cluster" takes its reserved meaning. Node names may become cluster-scoped (`alpha.cluster1.<rete>.rete`) — additive, resolved by context per [ADR-0007](/docs/implementation/adr/0007-decouple-naming-identity-routing), with the cluster as a locality/addressing axis rather than a separate identity.
