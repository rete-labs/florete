...
Everything else (CA, per-node bundles, revocation, `flor agent sync --commit-timeout`, coordinator-fronted distribution, naming, version-stamped envelope, SOCKS5 proxy, emergency-access safety net) is identical to C0.
